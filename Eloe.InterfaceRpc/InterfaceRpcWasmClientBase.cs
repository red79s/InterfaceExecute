...
{
    public class InterfaceRpcWasmClientBase
    {
        ...
        private InterfaceRpcSendCollectionWasmClient _sendCollection;

        public InterfaceRpcWasmClientBase(ILogger logger, bool logComunication = false)
        {
            ...
            _sendCollection = new InterfaceRpcSendCollectionWasmClient(_dataPacketFactory, logger);
