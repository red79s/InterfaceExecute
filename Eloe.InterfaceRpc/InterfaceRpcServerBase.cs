...
{
    public class InterfaceRpcServerBase
    {
        ...
        public InterfaceRpcServerBase(ILogger logger, bool logComunication = false)
        {
        ...
        protected void OnMessageReceived(MessageReceivedServerArgs e)
        {
